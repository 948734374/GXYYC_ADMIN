						...
						<div class="box-body table-responsive home-body" style="padding-top: 2%;">
								...
								<div class="info-box">
									...
									<div class="info-box-content">
										...
										<a href="${pageContext.request.contextPath}/shareCabinetController/toCabinetPage.do">
											<span class="info-box-number" id="totalUsers" style="font-size: 22px;"></span>
										</a>
									</div>
								</div>
							</div>
							...
							<div class="col-md-4 col-sm-6 col-xs-12">
								<div class="info-box">
									...
									<div class="info-box-content">
										<span class="info-box-text">平台订单</span>
							...
							<div class="col-md-4 col-sm-6 col-xs-12">
								<div class="info-box">
									...
									<div class="info-box-content">
										<span class="info-box-text">设备投放总量</span>
										<a href="${pageContext.request.contextPath}/shareMoneyController/list.do?flag=3">
											<span class="info-box-number" id="totalEquipment" style="font-size: 22px;"></span>
										</a>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-lg-6 col-xs-12">
								...
								<div class="box box-info">
									...
									<div class="box-body chart-responsive">
										<div class="chart" id="user-total" style="height: 400px;"></div>
									</div>
								</div>
							...
							<div class="col-md-6 col-lg-6 col-xs-12">
								<div class="home-title">
									<font size="5px" color="red">平台订单</font>
								</div>
								...
								<div class="box box-info">
									...
									<div class="box-body chart-responsive">
										<div class="chart2" id="user-order" style="height: 400px;"></div>
									</div>
								</div>
							...
							<div class="col-md-6 col-lg-6 col-xs-12">
								<div class="home-title">
									<font size="5px" color="red">设备投放总量</font>
								</div>
								...
								<div class="box box-info">
									...
									<div class="box-body chart-responsive">
										<div class="chart3" id="user-equipment" style="height: 400px;"></div>
									</div>
								</div>
