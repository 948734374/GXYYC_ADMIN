...
public class SimpleSSLMail{
	...
	//服务器地址
	private static  String SMTP_HOST_NAME = "smtp.mxhichina.com";
	//端口号
    private static  int SMTP_HOST_PORT = 465;
    //企业邮箱授权账号
    private static  String SMTP_AUTH_USER = "mcadmin@mcfish.cn";
    //授权账号密码
    private static  String SMTP_AUTH_PWD  = "McAdminMail@@";
    //发送方账号
    private static  String Address  = "mcadmin@mcfish.cn";
					...
					for (int i = 0; i < emails.length; i++) {
						...
						try {
							  message.addRecipient(Message.RecipientType.TO,
							             new InternetAddress(emails[i],null));
						      transport.connect
